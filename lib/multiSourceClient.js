...
// TODO: Re-enable for Pro feature - Google Docs upload
...
export class MultiSourceClient {
    ...
    async initialize() {
        try {
            console.log(`⚠️ Google APIs temporarily disabled - Multi-Source client unavailable for: ${this.clientId}`);
            console.log(`💡 This will be re-enabled for the Pro feature: Google Docs upload`);
            return false;

            // TODO: Uncomment when re-enabling Google APIs
            /*
