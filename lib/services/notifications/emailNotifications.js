                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                                ...
                                                ${leadInfo.has_insurance !== null && leadInfo.has_insurance !== undefined ? `
                                                <tr>
                                                    <td style="padding: 10px 0; border-bottom: 1px solid #e5e7eb;">
                                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                                            <tr>
                                                                ...
                                                                <td style="font-size: 14px; color: #111827;">
                                                                    ${leadInfo.has_insurance ?
                                                                        `<span style="color: #16a34a; font-weight: 600;">✓ Has Insurance</span>` :
                                                    ...
                                                    <td style="padding: 10px 0; border-bottom: 1px solid #e5e7eb;">
                                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                                            <tr>
                                                                ...
                                                                <td style="font-size: 14px; color: #111827;">
                                                                    <strong>${leadInfo.insurance_provider}</strong>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
