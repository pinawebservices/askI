...
export async function sendLeadNotificationEmail(leadInfo, clientId) {
    try {
        ...
        const htmlContent = generateBrandedLeadEmail(leadInfo, client.business_name);
 ...
 */
function generateBrandedLeadEmail(leadInfo, businessName) {
                            ...
                            <td style="padding: 48px 40px;">
                                ...
                                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-bottom: 32px; padding: 16px; background-color: #fef3c7; border-radius: 8px; border-left: 4px solid #f59e0b;">
                                    <tr>
                                        <td>
                                            <p style="margin: 0; font-size: 14px; line-height: 1.5; color: #78350f;">
                                                <strong style="color: #92400e;">After Hours Lead</strong><br/>
